...
class GridBasedPooling(torch.nn.Module):
    ...
    def social(self, hidden_state, obs1, obs2):
        ...
        hidden_state_grid = hidden_state.repeat(num_tracks, 1).reshape(num_tracks, num_tracks, -1)
    ...
    def occupancy(self, obs, other_values=None, past_obs=None):
        ...
        occ_2d = occ.reshape(num_tracks, -1, self.n * self.pool_size, self.n * self.pool_size)
